...
Contains one class, MudServer, which can be instantiated to start a server
running then used to send and receive messages from players.
...
class MudServer(object):
    ...
    def get_disconnected_players(self):
        ...
        # go through all the events in the main list
        for ev in self._events:
            # if the event is a player disconnect occurrence, add the info to
            # the list
    ...
    def _attempt_send(self, clid, data):
        # python 2/3 comparability fix - convert non-unicode string to unicode
    ...
    def _check_for_disconnected(self):
        ...
        for id, cl in list(self._clients.items()):
            ...
            # an error will be raised and we'll know that the client has
            # disconnected.
        ...
        for id, cl in list(self._clients.items()):
            ...
            try:
                ...
                if message:
                    ...
                    # remove any spaces, tabs etc from the start and end of the
                    # message
    ...
    def _process_sent_data(self, client, data):
        ...
        for c in data:
            ...
            if state == self._READ_STATE_NORMAL:
                ...
                # Set 'message' to the contents of the buffer and clear the
                # buffer
                elif c == "\n":
            ...
            # command state
                ...
                # otherwise. We switch into 'subnegotiation' state to handle
                # this
