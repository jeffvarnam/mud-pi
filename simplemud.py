...
while True:
    ...
    for id, command, params in mud.get_commands():
        ...
        if players[id]["name"] is None:
            ...
            mud.send_message(
                id, "Welcome to the game, %s. Type 'help' for a list of commands. Have fun!" % players[id]["name"])
        ...
        # 'help' command
            ...
            mud.send_message(
                id, "  look           - Examines the surroundings, e.g. 'look'")
            mud.send_message(
                id, "  go <exit>      - Moves through the exit specified, e.g. 'go outside'")
            ...
            if ex in rm["exits"]:
                ...
                for pid, pl in players.items():
                    ...
                    if players[pid]["room"] == players[id]["room"] and pid != id:
                        # send them a message telling them that the player left
                        # the room
                ...
                mud.send_message(id, "You arrive at '%s'" %
                                 players[id]["room"])
